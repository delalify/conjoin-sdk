...
describeAuthSdkContractCases('Auth organization SDK contract integration', [
  {
    ...
    method: 'POST',
    path: '/v1/auth/organization/{app_id}/create',
    expectedBody: createOrganizationBody,
    expectedPath: `/v1/auth/organization/${APP_ID}/create`,
    expectedPathParams: { app_id: APP_ID },
    response: conjoinSuccess(authOrganizationFixture(), { requestId: REQUEST_ID, status: 201 }),
    run: context => createAuthOrganizations(context.client).create(APP_ID, createOrganizationBody),
    assertResult: result => expect(result).toEqual(authOrganizationFixture()),
  },
  {
    name: 'reads an auth organization',
    method: 'GET',
    path: '/v1/auth/organization/{app_id}/{organization_id}',
    expectedPath: `/v1/auth/organization/${APP_ID}/${ORGANIZATION_ID}`,
    ...
    run: context => createAuthOrganizations(context.client).read(APP_ID, ORGANIZATION_ID),
    assertResult: result => expect(result).toEqual(authOrganizationFixture()),
  },
  {
    name: 'lists auth organizations',
    method: 'GET',
    path: '/v1/auth/organization/{app_id}',
    expectedPath: `/v1/auth/organization/${APP_ID}`,
    expectedPathParams: { app_id: APP_ID },
    expectedQuery: { limit: '1', 'query[slug]': 'contract-organization' },
    expectedRawBody: '',
    response: conjoinList([authOrganizationFixture()], { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizations(context.client).list(APP_ID, { limit: 1, query: { slug: 'contract-organization' } }),
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/{app_id}/{organization_id}/update',
    expectedBody: updateOrganizationBody,
    expectedPath: `/v1/auth/organization/${APP_ID}/${ORGANIZATION_ID}/update`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    response: conjoinSuccess(authOrganizationFixture({ name: 'Renamed Organization' }), { requestId: REQUEST_ID }),
    run: context => createAuthOrganizations(context.client).update(APP_ID, ORGANIZATION_ID, updateOrganizationBody),
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/{app_id}/{organization_id}/settings/update',
    expectedBody: organizationSettingsBody,
    expectedPath: `/v1/auth/organization/${APP_ID}/${ORGANIZATION_ID}/settings/update`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    response: conjoinSuccess(authOrganizationFixture({ settings: organizationSettingsBody }), {
      requestId: REQUEST_ID,
    }),
    run: context =>
      createAuthOrganizations(context.client).updateSettings(APP_ID, ORGANIZATION_ID, organizationSettingsBody),
  ...
  },
  {
    ...
    method: 'DELETE',
    path: '/v1/auth/organization/{app_id}/{organization_id}/delete',
    expectedBody: deleteOrganizationBody,
    expectedPath: `/v1/auth/organization/${APP_ID}/${ORGANIZATION_ID}/delete`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    response: conjoinSuccess(authOrganizationFixture({ date_deleted: '2026-05-16T01:00:00.000Z' }), {
      requestId: REQUEST_ID,
    }),
    run: context => createAuthOrganizations(context.client).delete(APP_ID, ORGANIZATION_ID, deleteOrganizationBody),
    assertResult: result =>
