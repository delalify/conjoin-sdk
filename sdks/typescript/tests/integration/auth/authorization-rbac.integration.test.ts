...
describeAuthSdkContractCases('Auth organization permission SDK contract integration', [
  {
    ...
    method: 'POST',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/create',
    expectedBody: createPermissionBody,
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/create`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    response: conjoinSuccess(authPermissionFixture(), { requestId: REQUEST_ID, status: 201 }),
    run: context =>
      createAuthOrganizationPermissions(context.client).createOrgPermission(
        APP_ID,
        ORGANIZATION_ID,
  ...
  },
  {
    ...
    method: 'GET',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/{permission_id}',
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/${PERMISSION_ID}`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, permission_id: PERMISSION_ID },
    response: conjoinSuccess(authPermissionFixture(), { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationPermissions(context.client).readOrgPermission(APP_ID, ORGANIZATION_ID, PERMISSION_ID),
    assertResult: result => expect(result).toEqual(authPermissionFixture()),
  },
  {
    name: 'lists organization permissions',
    method: 'GET',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission',
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    expectedQuery: { limit: '1', 'query[key]': 'project.read' },
    expectedRawBody: '',
    response: conjoinList([authPermissionFixture()], { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationPermissions(context.client).listOrgPermissions(APP_ID, ORGANIZATION_ID, {
        limit: 1,
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/{permission_id}/update',
    expectedBody: updatePermissionBody,
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/${PERMISSION_ID}/update`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, permission_id: PERMISSION_ID },
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/{permission_id}/archive',
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/${PERMISSION_ID}/archive`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, permission_id: PERMISSION_ID },
    response: conjoinSuccess(authPermissionFixture({ date_deleted: '2026-05-16T01:00:00.000Z' }), {
      requestId: REQUEST_ID,
    }),
    run: context =>
      createAuthOrganizationPermissions(context.client).archiveOrgPermission(APP_ID, ORGANIZATION_ID, PERMISSION_ID),
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/{permission_id}/restore',
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/${PERMISSION_ID}/restore`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, permission_id: PERMISSION_ID },
    response: conjoinSuccess(authPermissionFixture({ date_deleted: null }), { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationPermissions(context.client).restoreOrgPermission(APP_ID, ORGANIZATION_ID, PERMISSION_ID),
    assertResult: result => expect(result).toEqual(authPermissionFixture({ date_deleted: null })),
  },
  {
    name: 'deletes an organization permission',
    method: 'DELETE',
    path: '/v1/auth/organization/permission/{app_id}/organization/{organization_id}/permission/{permission_id}/delete',
    expectedPath: `/v1/auth/organization/permission/${APP_ID}/organization/${ORGANIZATION_ID}/permission/${PERMISSION_ID}/delete`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, permission_id: PERMISSION_ID },
    response: conjoinSuccess(authPermissionFixture({ date_deleted: '2026-05-16T01:00:00.000Z' }), {
      requestId: REQUEST_ID,
    }),
    run: context =>
      createAuthOrganizationPermissions(context.client).deleteOrgPermission(APP_ID, ORGANIZATION_ID, PERMISSION_ID),
    assertResult: result => expect(result).toEqual(authPermissionFixture({ date_deleted: '2026-05-16T01:00:00.000Z' })),
  },
])
...
describeAuthSdkContractCases('Auth organization role and role-permission SDK contract integration', [
  {
    ...
    method: 'POST',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/create',
    expectedBody: createRoleBody,
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/create`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    response: conjoinSuccess(authRoleFixture(), { requestId: REQUEST_ID, status: 201 }),
    run: context => createAuthOrganizationRoles(context.client).createOrgRole(APP_ID, ORGANIZATION_ID, createRoleBody),
    assertResult: result => expect(result).toEqual(authRoleFixture()),
  },
  {
    name: 'reads an organization role',
    method: 'GET',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinSuccess(authRoleFixture(), { requestId: REQUEST_ID }),
    run: context => createAuthOrganizationRoles(context.client).readOrgRole(APP_ID, ORGANIZATION_ID, ROLE_ID),
    assertResult: result => expect(result).toEqual(authRoleFixture()),
  },
  {
    name: 'lists organization roles',
    method: 'GET',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID },
    expectedQuery: { limit: '1', 'query[key]': 'admin' },
    expectedRawBody: '',
    response: conjoinList([authRoleFixture()], { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationRoles(context.client).listOrgRoles(APP_ID, ORGANIZATION_ID, {
        limit: 1,
        query: { key: 'admin' },
      }),
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}/update',
    expectedBody: updateRoleBody,
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/update`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinSuccess(authRoleFixture({ name: 'Owner' }), { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationRoles(context.client).updateOrgRole(APP_ID, ORGANIZATION_ID, ROLE_ID, updateRoleBody),
    assertResult: result => expect(result).toEqual(authRoleFixture({ name: 'Owner' })),
  },
  {
    name: 'archives an organization role',
    method: 'PATCH',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}/archive',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/archive`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinSuccess(authRoleFixture({ date_deleted: '2026-05-16T01:00:00.000Z' }), { requestId: REQUEST_ID }),
    run: context => createAuthOrganizationRoles(context.client).archiveOrgRole(APP_ID, ORGANIZATION_ID, ROLE_ID),
  ...
  },
  {
    ...
    method: 'PATCH',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}/restore',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/restore`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinSuccess(authRoleFixture({ date_deleted: null }), { requestId: REQUEST_ID }),
    run: context => createAuthOrganizationRoles(context.client).restoreOrgRole(APP_ID, ORGANIZATION_ID, ROLE_ID),
    assertResult: result => expect(result).toEqual(authRoleFixture({ date_deleted: null })),
  },
  {
    name: 'deletes an organization role',
    method: 'DELETE',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}/delete',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/delete`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinSuccess(authRoleFixture({ date_deleted: '2026-05-16T01:00:00.000Z' }), { requestId: REQUEST_ID }),
    run: context => createAuthOrganizationRoles(context.client).deleteOrgRole(APP_ID, ORGANIZATION_ID, ROLE_ID),
    assertResult: result => expect(result).toEqual(authRoleFixture({ date_deleted: '2026-05-16T01:00:00.000Z' })),
  },
  {
    name: 'reads organization role permissions',
    method: 'GET',
    path: '/v1/auth/organization/role/{app_id}/organization/{organization_id}/role/{role_id}/permissions',
    expectedPath: `/v1/auth/organization/role/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/permissions`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    response: conjoinList(['project.read'], { requestId: REQUEST_ID }),
    run: context =>
      createAuthOrganizationRoles(context.client).readOrgRolePermissions(APP_ID, ORGANIZATION_ID, ROLE_ID),
  ...
  },
  {
    ...
    method: 'POST',
    path: '/v1/auth/organization/role/permission/{app_id}/organization/{organization_id}/role/{role_id}/permission/assign',
    expectedBody: assignRolePermissionBody,
    expectedPath: `/v1/auth/organization/role/permission/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/permission/assign`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
  ...
  },
  {
    ...
    method: 'GET',
    path: '/v1/auth/organization/role/permission/{app_id}/organization/{organization_id}/role/{role_id}/permission',
    expectedPath: `/v1/auth/organization/role/permission/${APP_ID}/organization/${ORGANIZATION_ID}/role/${ROLE_ID}/permission`,
    expectedPathParams: { app_id: APP_ID, organization_id: ORGANIZATION_ID, role_id: ROLE_ID },
    ...
    run: context =>
      createAuthOrganizationRolePermissions(context.client).listOrgRolePermissions(APP_ID, ORGANIZATION_ID, ROLE_ID, {
        limit: 1,
