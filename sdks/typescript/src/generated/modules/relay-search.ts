...
type CreateIndexData = NonNullable<
  operations['createSearchIndex']['responses']['201']['content']['application/json']['data']
>
type ReadIndexesData = NonNullable<
  operations['readSearchIndexes']['responses']['200']['content']['application/json']['data']
>[number]
type ReadIndexesQuery = NonNullable<operations['readSearchIndexes']['parameters']['query']>
type DeleteIndexData = NonNullable<
  operations['deleteSearchIndex']['responses']['200']['content']['application/json']['data']
>
type IndexDocumentBody = operations['indexSearchDocument']['requestBody']['content']['application/json']
type IndexDocumentData = NonNullable<
  operations['indexSearchDocument']['responses']['201']['content']['application/json']['data']
>
type IndexDocumentBatchBody = operations['indexSearchDocumentBatch']['requestBody']['content']['application/json']
type IndexDocumentBatchData = NonNullable<
  operations['indexSearchDocumentBatch']['responses']['201']['content']['application/json']['data']
>[number]
...
type AutoSuggestData = NonNullable<
  operations['autoSuggestSearch']['responses']['200']['content']['application/json']['data']
>
...
export function createRelaySearches(client: ConjoinClient) {
  return {
    ...
    indexDocumentBatch: (indexId: string, data: IndexDocumentBatchBody) =>
      client.fetchList<IndexDocumentBatchData>(`relay/search/indexes/${indexId}/documents/batch`, {
        method: 'POST',
        body: data,
      }),

    removeDocument: (indexId: string, documentId: string) =>
      client.fetch<RemoveDocumentResponse>(`relay/search/indexes/${indexId}/documents/${documentId}`, {
        method: 'DELETE',
      }),
