...
type CreateData = NonNullable<
  operations['createConversation']['responses']['201']['content']['application/json']['data']
>
...
type DeleteData = NonNullable<
  operations['deleteConversation']['responses']['200']['content']['application/json']['data']
>
type ArchiveBody = operations['archiveConversation']['requestBody']['content']['application/json']
type ArchiveData = NonNullable<
  operations['archiveConversation']['responses']['200']['content']['application/json']['data']
>
type UpdateBody = operations['updateConversation']['requestBody']['content']['application/json']
type UpdateData = NonNullable<
  operations['updateConversation']['responses']['200']['content']['application/json']['data']
>
type ListBody = operations['listConversations']['requestBody']['content']['application/json']
type ListData = NonNullable<
  operations['listConversations']['responses']['200']['content']['application/json']['data']
>[number]
type ReadMessagesData = NonNullable<
  operations['readConversationMessages']['responses']['200']['content']['application/json']['data']
>[number]
type ReadOneRecipientData = NonNullable<
  operations['readOneConversationRecipient']['responses']['200']['content']['application/json']['data']
>
type DeleteRecipientsData = NonNullable<
  operations['deleteConversationRecipients']['responses']['200']['content']['application/json']['data']
>
type ReadManyRecipientsData = NonNullable<
  operations['readManyConversationRecipients']['responses']['200']['content']['application/json']['data']
>[number]
type AddOneRecipientData = NonNullable<
  operations['addOneConversationRecipient']['responses']['200']['content']['application/json']['data']
>
type AddManyRecipientsData = NonNullable<
  operations['addManyConversationRecipients']['responses']['200']['content']['application/json']['data']
>[number]
...
export function createMessagingConversations(client: ConjoinClient) {
  return {
    ...
    readMessages: (conversationId: string, parentMessageId: string) =>
      client.fetchList<ReadMessagesData>(`messaging/conversations/${conversationId}/messages/${parentMessageId}`, {
        method: 'POST',
      }),
    ...
    deleteRecipients: (conversationId: string, recipientId: string) =>
      client.fetch<DeleteRecipientsData>(`messaging/conversations/${conversationId}/recipients/${recipientId}`, {
        method: 'DELETE',
      }),

    readManyRecipients: (conversationId: string) =>
      client.fetchList<ReadManyRecipientsData>(`messaging/conversations/${conversationId}/recipients`, {
        method: 'POST',
      }),
    ...
    addManyRecipients: (conversationId: string) =>
      client.fetchList<AddManyRecipientsData>(`messaging/conversations/${conversationId}/recipients/batch`, {
        method: 'POST',
      }),
  }
}
