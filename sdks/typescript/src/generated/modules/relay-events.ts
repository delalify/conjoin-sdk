...
type CreateEventChannelData = NonNullable<
  operations['createEventChannel']['responses']['201']['content']['application/json']['data']
>
type ReadEventChannelsData = NonNullable<
  operations['readEventChannels']['responses']['200']['content']['application/json']['data']
>[number]
...
type UpdateEventChannelData = NonNullable<
  operations['updateEventChannel']['responses']['200']['content']['application/json']['data']
>
type DeleteEventChannelData = NonNullable<
  operations['deleteEventChannel']['responses']['200']['content']['application/json']['data']
>
type CreateEventSubscriptionBody = operations['createEventSubscription']['requestBody']['content']['application/json']
type CreateEventSubscriptionData = NonNullable<
  operations['createEventSubscription']['responses']['201']['content']['application/json']['data']
>
type ReadEventSubscriptionsData = NonNullable<
  operations['readEventSubscriptions']['responses']['200']['content']['application/json']['data']
>[number]
...
type UpdateEventSubscriptionData = NonNullable<
  operations['updateEventSubscription']['responses']['200']['content']['application/json']['data']
>
type DeleteEventSubscriptionResponse =
  operations['deleteEventSubscription']['responses']['200']['content']['application/json']
type PublishEventBody = operations['publishEvent']['requestBody']['content']['application/json']
type PublishEventData = NonNullable<
  operations['publishEvent']['responses']['200']['content']['application/json']['data']
>
...
export function createRelayEvents(client: ConjoinClient) {
  return {
    ...
    updateEventChannel: (channelId: string, data: UpdateEventChannelBody) =>
      client.fetch<UpdateEventChannelData>(`relay/events/channels/${channelId}/update`, {
        method: 'PATCH',
        body: data,
      }),
    ...
    createEventSubscription: (channelId: string, data: CreateEventSubscriptionBody) =>
      client.fetch<CreateEventSubscriptionData>(`relay/events/channels/${channelId}/subscriptions/create`, {
        method: 'POST',
        body: data,
      }),

    readEventSubscriptions: (channelId: string, query?: ReadEventSubscriptionsQuery) =>
      client.fetchList<ReadEventSubscriptionsData>(`relay/events/channels/${channelId}/subscriptions`, {
        query: query as Record<string, unknown>,
      }),

    updateEventSubscription: (channelId: string, subscriptionId: string, data: UpdateEventSubscriptionBody) =>
      client.fetch<UpdateEventSubscriptionData>(
        `relay/events/channels/${channelId}/subscriptions/${subscriptionId}/update`,
        { method: 'PATCH', body: data },
      ),

    deleteEventSubscription: (channelId: string, subscriptionId: string) =>
      client.fetch<DeleteEventSubscriptionResponse>(
        `relay/events/channels/${channelId}/subscriptions/${subscriptionId}/delete`,
        { method: 'DELETE' },
      ),
    ...
    read: (channelId: string, query?: ReadQuery) =>
      client.fetchList<ReadData>(`relay/events/channels/${channelId}/events`, {
        query: query as Record<string, unknown>,
      }),
