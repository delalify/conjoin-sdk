...
type CreateIndexData = NonNullable<
  operations['createAiContextIndex']['responses']['201']['content']['application/json']['data']
>
type ListIndexesData = NonNullable<
  operations['listAiContextIndexes']['responses']['200']['content']['application/json']['data']
>[number]
type ListIndexesQuery = NonNullable<operations['listAiContextIndexes']['parameters']['query']>
type ReadIndexData = NonNullable<
  operations['readAiContextIndex']['responses']['200']['content']['application/json']['data']
>
type DeleteIndexData = NonNullable<
  operations['deleteAiContextIndex']['responses']['200']['content']['application/json']['data']
>
type SyncIndexData = NonNullable<
  operations['syncAiContextIndex']['responses']['200']['content']['application/json']['data']
>
...
type ListQueryLogsData = NonNullable<
  operations['listAiContextQueryLogs']['responses']['200']['content']['application/json']['data']
>[number]
...
export function createAiContexts(client: ConjoinClient) {
  return {
    ...
    readIndex: (indexId: string) => client.fetch<ReadIndexData>(`ai/context/context/indexes/${indexId}`),
    ...
    query: (data: QueryBody) => client.fetch<QueryData>('ai/context/context/query', { method: 'POST', body: data }),
