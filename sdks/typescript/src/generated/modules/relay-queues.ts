...
type CreateQueueDefinitionData = NonNullable<
  operations['createQueueDefinition']['responses']['201']['content']['application/json']['data']
>
type ReadQueueDefinitionsData = NonNullable<
  operations['readQueueDefinitions']['responses']['200']['content']['application/json']['data']
>[number]
...
type UpdateQueueDefinitionData = NonNullable<
  operations['updateQueueDefinition']['responses']['200']['content']['application/json']['data']
>
type DeleteQueueDefinitionData = NonNullable<
  operations['deleteQueueDefinition']['responses']['200']['content']['application/json']['data']
>
...
type ReadQueueTasksData = NonNullable<
  operations['readQueueTasks']['responses']['200']['content']['application/json']['data']
>[number]
type ReadQueueTasksQuery = NonNullable<operations['readQueueTasks']['parameters']['query']>
type ReadDeadLetterTasksData = NonNullable<
  operations['readDeadLetterTasks']['responses']['200']['content']['application/json']['data']
>[number]
type ReadDeadLetterTasksQuery = NonNullable<operations['readDeadLetterTasks']['parameters']['query']>
type ReplayDeadLetterTaskData = NonNullable<
  operations['replayDeadLetterTask']['responses']['200']['content']['application/json']['data']
>
...
export function createRelayQueues(client: ConjoinClient) {
  return {
    ...
    readQueueTasks: (queueId: string, query?: ReadQueueTasksQuery) =>
      client.fetchList<ReadQueueTasksData>(`relay/queues/${queueId}/tasks`, {
        query: query as Record<string, unknown>,
      }),

    readDeadLetterTasks: (queueId: string, query?: ReadDeadLetterTasksQuery) =>
      client.fetchList<ReadDeadLetterTasksData>(`relay/queues/${queueId}/dead-letter`, {
        query: query as Record<string, unknown>,
      }),

    replayDeadLetterTask: (queueId: string, dlqEntryId: string) =>
      client.fetch<ReplayDeadLetterTaskData>(`relay/queues/${queueId}/dead-letter/${dlqEntryId}/replay`, {
        method: 'POST',
      }),
  }
}
