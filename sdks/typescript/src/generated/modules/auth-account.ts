...
type ReadCredentialData = NonNullable<operations['readCredential']['responses']['200']['content']['application/json']['data']>
...
type ImportPasswordHashesBody = operations['importPasswordHashes']['requestBody']['content']['application/json']
type ImportPasswordHashesData = NonNullable<operations['importPasswordHashes']['responses']['200']['content']['application/json']['data']>
...
export function createAuthAccounts(client: ConjoinClient) {
  return {
    ...
    readCredential: (appId: string, accountId: string, credentialId: string) =>
      client.fetch<ReadCredentialData>(`auth/account/${appId}/account/${accountId}/credential/${credentialId}`),
    ...
    importPasswordHashes: (appId: string, data: ImportPasswordHashesBody) =>
      client.fetch<ImportPasswordHashesData>(`auth/account/${appId}/import/password-hashes`, { method: 'POST', body: data }),
  }
}
