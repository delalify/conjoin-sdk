...
type SendSmsMfaActivationCodeData = NonNullable<operations['sendSmsMfaActivationCode']['responses']['200']['content']['application/json']['data']>
...
export function createAuthCredentials(client: ConjoinClient) {
  return {
    ...
    sendSmsMfaActivationCode: (appId: string, accountId: string) =>
      client.fetch<SendSmsMfaActivationCodeData>(`auth/credential/${appId}/account/${accountId}/credential/mfa/sms/activation-code`, { method: 'POST' }),
