...
type DeleteBody = operations['deletePasskey']['requestBody']['content']['application/json']
...
export function createAuthPasskeys(client: ConjoinClient) {
  return {
    ...
    delete: (appId: string, accountId: string, credentialId: string, data: DeleteBody) =>
      client.fetch<DeleteData>(`auth/passkey/${appId}/account/${accountId}/passkeys/${credentialId}/delete`, { method: 'DELETE', body: data }),
  }
}
