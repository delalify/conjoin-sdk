...
type ListData = NonNullable<
  operations['listRoleAssignmentLogs']['responses']['200']['content']['application/json']['data']
>[number]
  ...
  return {
    list: (appId: string, organizationId: string, query?: ListQuery) =>
      client.fetchList<ListData>(
        `auth/organization/role-assignment-log/${appId}/organization/${organizationId}/role-assignment-logs`,
