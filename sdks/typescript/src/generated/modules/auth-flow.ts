...
type ConfirmLinkSignupBody = operations['confirmLinkSignup']['requestBody']['content']['application/json']
type ConfirmLinkSignupData = NonNullable<operations['confirmLinkSignup']['responses']['200']['content']['application/json']['data']>
...
export function createAuthFlows(client: ConjoinClient) {
  return {
    ...
    confirmLinkSignup: (appId: string, clientId: string, data: ConfirmLinkSignupBody) =>
      client.fetch<ConfirmLinkSignupData>(`auth/flow/${appId}/${clientId}/signup/confirm-link`, { method: 'POST', body: data }),
