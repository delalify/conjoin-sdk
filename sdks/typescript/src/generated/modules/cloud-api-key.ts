...
type CreateApiKeyData = NonNullable<
  operations['createCloudApiKey']['responses']['200']['content']['application/json']['data']
>
type RegenerateApiKeyBody = operations['regenerateCloudApiKey']['requestBody']['content']['application/json']
type RegenerateApiKeyData = NonNullable<
  operations['regenerateCloudApiKey']['responses']['200']['content']['application/json']['data']
>
type UpdateApiKeyBody = operations['updateCloudApiKey']['requestBody']['content']['application/json']
type UpdateApiKeyData = NonNullable<
  operations['updateCloudApiKey']['responses']['200']['content']['application/json']['data']
>
type ReadApiKeysData = NonNullable<
  operations['readCloudApiKeys']['responses']['200']['content']['application/json']['data']
>[number]
type ReadApiKeysQuery = NonNullable<operations['readCloudApiKeys']['parameters']['query']>
type DeleteApiKeyData = NonNullable<
  operations['deleteCloudApiKey']['responses']['200']['content']['application/json']['data']
>
