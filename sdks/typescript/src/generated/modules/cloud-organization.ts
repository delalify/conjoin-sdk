...
type CreateData = NonNullable<
  operations['createCloudOrganization']['responses']['201']['content']['application/json']['data']
>
type UpdateBody = operations['updateCloudOrganization']['requestBody']['content']['application/json']
type UpdateData = NonNullable<
  operations['updateCloudOrganization']['responses']['200']['content']['application/json']['data']
>
type ReadData = NonNullable<
  operations['readCloudOrganizations']['responses']['200']['content']['application/json']['data']
>[number]
...
export function createCloudOrganizations(client: ConjoinClient) {
  return {
    create: (data: CreateBody) => client.fetch<CreateData>('cloud/organizationnew', { method: 'POST', body: data }),
