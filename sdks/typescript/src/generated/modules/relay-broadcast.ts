...
type GenerateConnectionTokenData = NonNullable<
  operations['generateBroadcastConnectionToken']['responses']['200']['content']['application/json']['data']
>
type CreateChannelBody = operations['createBroadcastChannel']['requestBody']['content']['application/json']
type CreateChannelData = NonNullable<
  operations['createBroadcastChannel']['responses']['201']['content']['application/json']['data']
>
type ReadChannelsData = NonNullable<
  operations['readBroadcastChannels']['responses']['200']['content']['application/json']['data']
>[number]
...
type UpdateChannelData = NonNullable<
  operations['updateBroadcastChannel']['responses']['200']['content']['application/json']['data']
>
type DeleteChannelData = NonNullable<
  operations['deleteBroadcastChannel']['responses']['200']['content']['application/json']['data']
>
type GenerateAuthTokenBody = operations['generateBroadcastAuthToken']['requestBody']['content']['application/json']
type GenerateAuthTokenData = NonNullable<
  operations['generateBroadcastAuthToken']['responses']['200']['content']['application/json']['data']
>
...
type ReadPresenceData = NonNullable<
  operations['readBroadcastPresence']['responses']['200']['content']['application/json']['data']
>
...
export function createRelayBroadcasts(client: ConjoinClient) {
  return {
    ...
    generateAuthToken: (channelId: string, data: GenerateAuthTokenBody) =>
      client.fetch<GenerateAuthTokenData>(`relay/broadcast/channels/${channelId}/auth-token`, {
        method: 'POST',
        body: data,
      }),
