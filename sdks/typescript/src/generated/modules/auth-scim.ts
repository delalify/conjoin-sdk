...
type ScimPatchGroupMembersBody = operations['scimPatchGroupMembers']['requestBody']['content']['application/json']
...
type ScimBulkOperationsBody = operations['scimBulkOperations']['requestBody']['content']['application/json']
...
export function createAuthSCIMs(client: ConjoinClient, options: AuthSCIMOptions = {}) {
  return {
    ...
    scimPatchGroupMembers: (projectId: string, appId: string, id: string, data: ScimPatchGroupMembersBody) =>
      client.fetch<ScimPatchGroupMembersResponse>(`auth/scim/v2/${projectId}/${appId}/Groups/${id}`, { method: 'PATCH', body: data, ...scimBearerRequestOptions(options.scimToken) }),
    ...
    scimBulkOperations: (projectId: string, appId: string, data: ScimBulkOperationsBody) =>
      client.fetch<ScimBulkOperationsResponse>(`auth/scim/v2/${projectId}/${appId}/Bulk`, { method: 'POST', body: data, ...scimBearerRequestOptions(options.scimToken) }),
